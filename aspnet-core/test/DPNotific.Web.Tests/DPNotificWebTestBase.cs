...
{
    public abstract class DPNotificWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DPNotificWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DPNotificWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DPNotificDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DPNotificDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DPNotificDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DPNotificDbContext, Task<T>> func)
        {
            T result;
